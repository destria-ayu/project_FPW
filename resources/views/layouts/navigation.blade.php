    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            <div class="flex space-x-6">
                <!-- Menu Dashboard (Bisa diakses Admin & Kasir) -->
                ...
                <!-- Menu Transaksi (Kasir & Admin) -->
                <a href="{{ route('pos.index') }}"
                    class="{{ request()->routeIs('pos.index') ? 'text-indigo-600' : 'text-gray-500' }}">
                    Transaksi
                </a>

                <!-- Menu Khusus Kasir (Riwayat Transaksi Saya) -->
            ...
            <div class="flex items-center space-x-4 text-sm">
                <span class="text-gray-600">{{ auth()->user()->name }} ({{ strtoupper(auth()->user()->role) }})</span>
